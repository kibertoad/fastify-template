...
import type { BaseErrorParams, ErrorDetails } from "./types.ts";
...
const PUBLIC_NON_RECOVERABLE_ERROR_SYMBOL = Symbol.for(
	"PUBLIC_NON_RECOVERABLE_ERROR_KEY",
);
...
Object.defineProperty(
	PublicNonRecoverableError.prototype,
	PUBLIC_NON_RECOVERABLE_ERROR_SYMBOL,
	{
		value: true,
	},
);

export function isPublicNonRecoverableError(
	error: unknown,
): error is PublicNonRecoverableError {
	return (
		isNativeError(error) &&
